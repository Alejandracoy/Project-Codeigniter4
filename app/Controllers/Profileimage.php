...
class Profileimage extends BaseController
{
    ...
    public function update()
    {
        ...
        if ( ! $file->isValid()) {
            ...
            if ($error_code == UPLOAD_ERR_NO_FILE) {
                ...
                return redirect()->back()
                                 ->with('warning', lang('App.messages.noFile'));
            }
        ...
        if ($size > 2) {
            ...
            return redirect()->back()
                             ->with('warning', lang('App.messages.large'));
        }
        ...
        if ( ! in_array($type, ['image/png', 'image/jpeg'])) {
            ...
            return redirect()->back()
                             ->with('warning', lang('App.messages.invFile'));
        }
        ...
        service('image')
            ...
            return redirect()->to("/profile/show")
                             ->with('info', lang('App.messages.imgSucces'));
        }
        ...
        public function delete()
        {
            if ($this->request->getMethod() === 'post') {
                ...
                return redirect()->to('/profile/show')
                                 ->with('info', lang('App.messages.imgDelete'));
            }
