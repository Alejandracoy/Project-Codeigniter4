...
<?= form_open("/$locale/signup/create") ?>
    ...
    <div class="field">
        <label class="label" for="password_confirmation"><?=lang('Signup.passwordCon')?>
</label>
            <div class="control">
    ...
    <div class="field is-grouped">
            <div class="control">
                <button class="button is-primary"><?=lang('Signup.title')?></button>
            </div>

            <div class="control">
                <a class="button" href="<?= site_url("/") ?>"><?=lang('Signup.cancel')?>
</a>
            </div>
    </div>
